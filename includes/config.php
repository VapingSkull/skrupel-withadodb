...
$admin_login="admin";
$admin_pass=""; // Your Adminpassword here

//Absenderemail des Servers

$absenderemail=""; // Your Emailadress here * But for now it is not used *
...
ini_set('error_log', 'e:/xampp/htdocs/logs/error.log'); // full path to php Error Log

/* 
 * 
 * Servername 
 */
define ('servername', 'http://localhost/'); //Your Servername with / @the End
